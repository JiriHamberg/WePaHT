...
<html>
    ...
    <body>
       ...
       <form:form commandName="bookForm" action="${pageContext.request.contextPath}/app/books" method="POST">
           Title:<form:input id="title" path="title" /><form:errors path="title" /><br/>
           ISBN:<form:input id="isbn" path="ISBN" /><form:errors path="ISBN" /><br/>
           ...
           Publishing year:<form:input id="publishingYear" path="publishingYear" /><form:errors path="publishingYear" /><br/>
           Description:<form:input id="description" path="description" /><form:errors path="description" /><br/>
           <input type="submit">
       </form:form>
